export default {
	...
	menu: [

		{
			name: 'Home',
			route: 'Home',
			icon: `<svg width="18px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
	...
	icons: {
		...
		transfer: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
	...
	transactions: [
		...
		{
			info: 'Payment From Hussnain',
			amount: '$550',
			status: 'success',
			date: 'July 5, 2020'
		},
		{
			info: 'Payment From Ali',
			amount: '$900',
			status: 'success',
			date: 'June 2, 2020'
		},
		{
			info: 'Payment Sent to Zeeshan',
			amount: '$900',
			status: 'success',
			date: 'June 5, 2020'
		},
